...
public:
	...
	void checkCollisionHeightMap(XMFLOAT3& xmf3Shift, bool bUpdateVelocity);
	...
	float GetPlaySpeedChange() { return m_pSpeed; }
	void SetPlaySpeedChange(float pSpeed) { m_pSpeed = pSpeed; }

	bool GetPlaySprite() { return m_pSprite; }
	void SetPlaySprite(bool pSprite) { m_pSprite = pSprite; }
};
