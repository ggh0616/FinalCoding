...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	// m_pSpriteShader->CreateShader(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
	// m_pSpriteShader->BuildObjects(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, m_pTerrain);
...
void CScene::ReleaseObjects()
{
	...
	// if (m_pSpriteShader) delete m_pSpriteShader;
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	// pd3dDescriptorRanges[12].NumDescriptors = 2;
	// pd3dDescriptorRanges[12].BaseShaderRegister = 24; //t24-t25: SpriteTexture
...
bool CScene::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case 0x41:
			m_fZoomFactor += 0.1f;
			SetCameraZoom(m_fZoomFactor);
			break;
		case 0x44:
			// m_zoomFactor -= 0.1f;
			// SetCameraZoom(m_zoomFactor);
			break;
		case VK_RETURN:
...
void CScene::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	...
	// if (m_pSpriteShader->GetOnSprite())
	// {
	// 	m_pSpriteShader->Render(pd3dCommandList, pCamera, m_pPlayer);
	// }
}
